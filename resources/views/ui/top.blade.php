...
<div class="" style="width:10%">
    <form action="{{url('export')}}" method="POST">
        @csrf
        <input hidden type="datetime-local" class="form-control" id="game-date-time-text" name="start_date"
            value="{{ $from }}">
        <input hidden type="datetime-local" class="form-control" id="game-date-time-text" name="end_date"
            value="{{ $to }}">
